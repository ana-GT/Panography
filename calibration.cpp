...
#include <string.h>
#include <time.h>
//./calibration -w 9 -h 6 -s 0.0185 -o chessCamera.xml -op -oe -pt chessboard -n 9 chessPatterns.xml 
...
/**
 * @function calcChessboardCorners
 */
...
int main( int argc, char** argv )
{
	...
	// If image is valid
        ...
        imageSize = view.size();
	printf("[%d] Size of current image: (%d, %d) \n", i, imageSize.width, imageSize.height );
	...
	printf("Improve accuracy \n");
        if( pattern == CHESSBOARD && found) {
	  cornerSubPix( viewGray, pointbuf, Size(11,11),
			Size(-1,-1), TermCriteria( CV_TERMCRIT_EPS+CV_TERMCRIT_ITER, 30, 0.1 ));
	}
	printf("End improving accuracy \n");
